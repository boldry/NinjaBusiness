...
' ============================================================================
' Omni Service Financial Model Generator
' ============================================================================
' This VBA module creates a complete financial model sheet for Omni Service
' with recurring + one-time revenue, voice/text COGS model, and KPI calculations
' ============================================================================

Sub Create_OmniService_Sheet()
    ...
    Set ws = ThisWorkbook.Sheets("Omni Service")
    If ws Is Nothing Then
        Set ws = ThisWorkbook.Sheets.Add(After:=ThisWorkbook.Sheets(ThisWorkbook.Sheets.Count))
        ws.Name = "Omni Service"
    Else
        ws.Cells.Clear
    End If
    On Error GoTo 0
    ...
    With ws
        ' Header
        .Range("A1").Value = "OMNI SERVICE - 2026 FINANCIAL MODEL"
    ...
    MsgBox "Omni Service sheet created successfully!", vbInformation
